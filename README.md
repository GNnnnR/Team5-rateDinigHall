...
* 'styles.css' - Presentation file defining the visual layout of website
* 'img' - Folder with dining hall photos 
* 'script.js' - Front-end JavaScript file that handles all of the website functions

## Contact 
* Peilin Zhang 
    * GitHub Profile: [@PeilinZ456](https://github.com/PeilinZ456)
* Miaofen Zhou 
    * GitHub Profile: [@zmf116](https://github.com/zmf116)
* Sheila He 
    * GitHub Profile: [@GNnnnR](https://github.com/GNnnnR)
* Fiona Feng
    * GitHub Profile: [@Fiona-7788](https://github.com/Fiona-7788)
* Jocelyn Chen
    * GitHub Profile: [@jgchen8](https://github.com/jgchen8)
